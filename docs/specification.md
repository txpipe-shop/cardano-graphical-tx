...
It is possible to verify that the JSON that represents a transaction is valid by checking some verifier, such as the following: [hhttps://jsonschema.dev/s/3P1sI](https://jsonschema.dev/s/3P1sI).
