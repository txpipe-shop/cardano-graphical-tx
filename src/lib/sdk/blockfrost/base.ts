...
export const BASE_PATH = "https://cardano-mainnet.blockfrost.io/api/v0".replace(/\/+$/, "");
...
export const operationServerMap: ServerMap = {
    ...
    "IPFSGatewayApi.ipfsGatewayIPFSPathGet": [
        {
            url: "https://ipfs.blockfrost.io/api/v0",
            description: "No description provided",
        }
    ],
    "IPFSPinsApi.ipfsPinAddIPFSPathPost": [
        {
            url: "https://ipfs.blockfrost.io/api/v0",
            description: "No description provided",
        }
    ],
    "IPFSPinsApi.ipfsPinListGet": [
        {
            url: "https://ipfs.blockfrost.io/api/v0",
            description: "No description provided",
        }
    ],
    "IPFSPinsApi.ipfsPinListIPFSPathGet": [
        {
            url: "https://ipfs.blockfrost.io/api/v0",
            description: "No description provided",
        }
    ],
    "IPFSPinsApi.ipfsPinRemoveIPFSPathPost": [
        {
            url: "https://ipfs.blockfrost.io/api/v0",
            description: "No description provided",
        }
