...
export declare function validateCborTx(cbor: string, inputs: Array<ValidationInput>, pparamsJson: string, slot: bigint, networkId: number, networkMagic: number): ValidationResponse
