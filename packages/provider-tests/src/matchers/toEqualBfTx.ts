import { Address, cardano, DatumType } from '@laceanatomy/types';
import { TxContentUtxoInputsInner, TxContentUtxoOutputsInner } from '@laceanatomy/blockfrost-sdk';
import { BfComprehensiveTx } from '../types';
...
function addressesEqual(received: string, expected: string): boolean {
    try {
        ...
        // fallback if address parsing fails, though it shouldn't for valid addresses
