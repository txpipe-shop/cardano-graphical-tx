...
export const Header = () => {
  ...
  return (
    <header className="fixed left-0 top-0 box-border flex h-28 w-full flex-row items-center justify-between border-b-2 border-dashed border-b-gray-300 bg-white px-4 pb-4 pt-6 align-middle">
