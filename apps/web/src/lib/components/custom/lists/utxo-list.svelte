      ...
      <TableBody>
        {#each (list as UTxO[]) as utxo}
          <TableRow>
            ...
            <TableCell class="font-mono break-all whitespace-pre-wrap text-sm w-1/12">
              {#if utxo.datum}
                <Badge variant="outline" class="cursor-pointer text-white bg-accent-foreground dark:bg-accent" onclick={() => goToDatumTab(utxo.outRef)} >
                  Yes
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
                  <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
                    <path d="M 84 37.02 c -3.313 0 -6 -2.687 -6 -6 V 12 H 58.98 c -3.313 0 -6 -2.687 -6 -6 s 2.687 -6 6 -6 H 84 c 3.313 0 6 2.687 6 6 v 25.02 C 90 34.333 87.313 37.02 84 37.02 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round"/>
                    ...
                    <path d="M 73.658 90 H 16.341 C 7.331 90 0 82.669 0 73.658 V 16.341 C 0 7.331 7.331 0 16.341 0 h 17.62 c 3.313 0 6 2.687 6 6 s -2.687 6 -6 6 h -17.62 C 13.947 12 12 13.947 12 16.341 v 57.317 C 12 76.053 13.947 78 16.341 78 h 57.317 C 76.053 78 78 76.053 78 73.658 V 56.039 c 0 -3.313 2.687 -6 6 -6 s 6 2.687 6 6 v 17.619 C 90 82.669 82.669 90 73.658 90 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round"/>
                  </g>
                  </svg>
                </Badge>
              {:else}
