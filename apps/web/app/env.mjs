...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    MAINNET_DOLOS_BLOCKFROST_API_KEY: process.env.MAINNET_DOLOS_BLOCKFROST_API_KEY,
    PREPROD_DOLOS_BLOCKFROST_API_KEY: process.env.PREPROD_DOLOS_BLOCKFROST_API_KEY,
    PREVIEW_DOLOS_BLOCKFROST_API_KEY: process.env.PREVIEW_DOLOS_BLOCKFROST_API_KEY,
