...
const networkSchema = z.enum(["mainnet", "preprod", "preview", "devnet"], {
...
export const getTxFromDevnetCBORSchema = z.object({
  txCbor: z.string({ required_error: "Transaction CBOR is required" }),
});
