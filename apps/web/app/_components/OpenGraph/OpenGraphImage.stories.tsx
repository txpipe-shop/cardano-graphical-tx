...
import { OPEN_GRAPH_IMAGE_SIZE, OpenGraphImage } from "./OpenGraphImage";
...
export const Block: Story = {
  args: {
    ...
    title: "Block 3787101",
    eyebrow: "Block",
    description: "15 transactions, 2.481932 ₳ total fees, slot 76492312.",
    chain: "preprod",
    facts: [
      [
        "Hash",
        "3abfb9d7ad3154a47ef1292a7f816e82664825b9b2176c982cb4e6e947b09d5e",
      ],
      ["Slot", "76492312"],
      ["Txs", "15"],
      ["Fees", "2.481932 ₳"],
...
export const Token: Story = {
  args: {
    ...
    description: "1,000,000 supply, 24 holder preview, 3 mint/burn events.",
    chain: "preprod",
    facts: [
...
export const LongValues: Story = {
  args: {
    ...
    facts: [
      [
        "Hash",
        "b15a2e8a6366dedcf3d4b84d5332fcae849746766aecbcb3af2328a665236d0a",
      ],
      ["Policy", "2b424eb51d04e39cfe7483ffe60eda9c5388d622d2bbb10443631818"],
      [
        "Address",
...
export const SixFactsTallContent: Story = {
  args: {
    ...
    facts: [
      ...
      [
        "Stake key",
        "stake_test1uq78w3x84f4v76e60pkxj0psrj6q6e3y5ezh9jz0u7xtsqsp8wdm9",
      ],
    ],
  },
};
